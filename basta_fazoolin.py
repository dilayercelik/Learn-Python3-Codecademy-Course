...
class Menu():
    ...
    def __repr__(self):
        representation = self.name + ' menu' + ' available from ' + \
...
# Question 6
kid_items = {'chicken nuggets': 6.50, 'fusilli with wild mushrooms': 12.00,
             'apple juice': 3.00}
...
first_business = Business("Basta Fazoolin' with my Heart",
                          franchises_for_first)


# Question 22
items = {'arepa pabellon': 7.00, 'pernil arepa': 8.50,
